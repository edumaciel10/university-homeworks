...
public class GraphController {
    public static void main(String[] args) {
        ...
        graph.addEdge(vertices.get(1), vertices.get(3), 1);
        graph.addEdge(vertices.get(2), vertices.get(0), 1);
        graph.addEdge(vertices.get(4), vertices.get(2), 1);
        graph.addEdge(vertices.get(3), vertices.get(4), 1);
        graph.addEdge(vertices.get(4), vertices.get(1), 1);
        graph.addEdge(vertices.get(3), vertices.get(0), 1);
        graph.addEdge(vertices.get(3), vertices.get(1), 1);
